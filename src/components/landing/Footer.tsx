...
export function Footer({ onOpenDemo }: FooterProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Footer columns slide up
      const cols = footer.querySelectorAll('.footer__top > *');
    ...
    <footer className="footer" ref={footerRef}>
      <div className="container">
        <div className="footer__top">
          <div className="footer__brand">
            <a href="#" className="footer__brand-logo">
              ...
              <span className="footer__brand-name">Vansales</span>
            </a>
            <p className="footer__brand-desc">
              Mobile-first field sales management platform for modern
          ...
          <div>
            ...
            <ul className="footer__links">
              ...
              <li><button onClick={onOpenDemo} className="footer__link" style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', font: 'inherit' }}>Contact</button></li>
            </ul>
          </div>
        ...
        <div className="footer__bottom">
          <span className="footer__copy">&copy; 2026 Vansales. All rights reserved.</span>
